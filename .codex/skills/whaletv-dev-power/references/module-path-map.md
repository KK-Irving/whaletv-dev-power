...
### Audio / DroidAudio / PID & Smart Partition (X5/STB)

| Submodule | Path Prefix | Description |
|-----------|------------|-------------|
| DroidAudio INI Resolver | vendor/amlogic/common/interfaces/droidaudio/default/ | whale_audio_ini_resolver.cpp (5-step fallback) |
| DroidAudioManagerSetting | hardware/amlogic/audio framework | Audio audio framework config |
| PID Build Script (SmartPidCopy) | script/compile/base_pid.sh | Copies single PID config to smart.img |
| Smart Image Build (BuildImage) | script/compile/base.sh | smartBuildImage, packs all PID configs |
| PID Repository | cogit/pid/customer_{name}/{chipType}/ | Root of PID config repo |
| PID Model Config | cogit/pid/customer_{name}/{chipType}/model/pid*.cfg | AQ_ID + AUDIO_INI_ID + all PID fields |
| PID Model Summary | cogit/pid/customer_{name}/{chipType}/model/model_sum.ini | Maps PID to panel/AQ/PQ paths |
| Smart Partition Runtime | /smart/etc/whalepid/ | Smart/Full: locked single PID config |
| Vendor PID Runtime | /vendor/etc/whalepid/ | Basic: all PIDs, switchable |
| PID Board Config | cogit/pid/customer_{name}/{chipType}/board/ | Per-board-type configs |
| PID Audio (AQ) Config | cogit/pid/customer_{name}/{chipType}/tvconfig/audio/ | AMLOGIC_SOC.ini per AUDIO_ID |
| PID Panel Config | cogit/pid/customer_{name}/{chipType}/tvconfig/panel/ | Panel param JSON files |
| PID PQ Config | cogit/pid/customer_{name}/{chipType}/tvconfig/pq/ | overscan.db, pq.bin per PQ_ID |
| PID HDMI EDID Config | cogit/pid/customer_{name}/{chipType}/tvconfig/hdmi/ | EDID bins per EDID_ID |
| PID Remote Config | cogit/pid/customer_{name}/{chipType}/tvconfig/mr/ | Remote tab + remote.sum |
| PID Remote KL Config | cogit/pid/customer_{name}/{chipType}/tvconfig/key_kl/ | Key layout files + kl_map.conf |
| PID Keypad Config | cogit/pid/customer_{name}/{chipType}/tvconfig/mkp/ | Keypad tab files |
| PID DTBO Overlay | cogit/pid/customer_{name}/{chipType}/overlay/dts/ | Per-PID DTS overlay |
| PID Hotkey Map | cogit/pid/customer_{name}/{chipType}/hotkey_map/ | hotkey_map.json |
