...
```
[knowledge-mcp-server v1.0.2] started — db=./data/knowledge.db, model=Xenova/bge-small-zh-v1.5 (dim=512, threads=2)
```
...
- [ ] knowledge-mcp v1.0.2：sync_zmind / sync_gerrit / sync_confluence（auto + mode:"html"）各跑一批
